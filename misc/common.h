...
#define HVSC_SYSCALL_ADDR_465		0x80000000001A6A1CULL
#define HVSC_SYSCALL_ADDR_465D		0x80000000001ACECCULL	// where above syscall is in lv2 4.65 DEX
...
#define HVSC_SYSCALL_ADDR_475		0x80000000002A0F58ULL	// where above syscall is in lv2 4.75
...
#define HVSC_SYSCALL_ADDR_481		0x80000000002A0F58ULL	// where above syscall is in lv2 4.81
...
#define NEW_POKE_SYSCALL_ADDR_465	0x80000000001A6F44ULL
#define NEW_POKE_SYSCALL_ADDR_465D	0x80000000001AD3F4ULL
...
#define NEW_POKE_SYSCALL_ADDR_475	0x80000000002A1480ULL	// where above syscall is in lv2 4.75
...
#define NEW_POKE_SYSCALL_ADDR_481	0x80000000002A1480ULL	// where above syscall is in lv2 4.81
